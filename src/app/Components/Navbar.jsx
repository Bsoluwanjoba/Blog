...
export default function Navbar() {
  ...
  return (
    // <Parallax speed={-8}>
            ...
            <ul className={`md:flex md:flex-row ${showNav ? 'flex' : 'hidden'} flex-col justify-between md:h-10 h-[60vh] items-center`}>
            ...
            <button className="bg-[purple] duration-700 px-6 py-2 mx-4 font-medium rounded hover:text-[yellow]">
           {` Get a Coupon!`}
            </button>
        </ul>
