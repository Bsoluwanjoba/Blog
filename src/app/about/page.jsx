     ...
     <div className={`${styles.header}`}>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[70%] m-auto gap-5'>
       ...
       <Image src='https://robohash.org/home' alt='author' width={90} height={90} className={styles.image}/>
          ...
          <Link href='https://wa.link/vx9kq6'> <p className='bg-[red] p-[7px] text-white w-[110px] rounded-sm h-[30px] text-[14px] mt-[50px] ml-[115px] text-center items-center'>Contact Me</p></Link>
       </div>
