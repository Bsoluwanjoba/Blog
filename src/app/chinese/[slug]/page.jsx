'use client'
import { foods } from "@/app/recipe/page"
...
export default function Page({params}) {
 ...
 const filteredFoods = foods.filter(food => food.category == foodCard.category && food.title !== foodCard.title)
  ...
  return (
    ...
    <section className="">
          <section className={`py-[5.2em] h-[500px] md:w-[598px] lg:w-[1498px]  lg:bg:cover ${styles.border}`}  style={{backgroundImage: `radial-gradient(rgba(0, 0, 0, 0.800), rgba(0, 0, 0, 0.800)), url(/images/${foodCard.image}.jpeg)`}} >
        
              <div className=" bg-[red] w-[350px] h-[190px] mt-[110px] md:ml-[30px] lg:ml-[300px] p-[15px] text-white font-semibold tracking-[0.3em] text-[13px] leading-8 bg-opacity-70 rounded-md">
        ...
        <div className="text-black md:w-[80%] lg:w-[60%] leading-8 mt-[68px]">
        <ul>
        ...
        <div className="float-right md:mt-[100px] lg:-mt-[690px] mr-[84px] leading-9 bg-[#ffe] shadow-2xl p-[50px] h-[430px] w-[330px]">
          <p className="text-xl font-semibold text-center text-[red] mb-[20px]">Ingredients</p>
            ...
            <h2 className={`text-[25px] font-bold text-[red] leading-[25px] tracking-widest items-center p-[5px] md:mt:[80px] ${styles.borderr}`}>Related Foods</h2>
            <div className="grid md:grid-cols-1 lg:grid-cols-3 rounded-md mt-[20px]">
